...
use super::{
    NewUnstableBeaconStartEventContent, NewUnstableBeaconStartEventContentWithoutRelation,
    ReplacementUnstableBeaconStartEventContent, UnstableBeaconStartContentBlock,
        ...
        D: Deserializer<'de>,
    {
        ...
        let c = match relates_to {
            Some(Relation::Replacement(relates_to)) => {
                ReplacementUnstableBeaconStartEventContent { beacon_start, text, relates_to }.into()
            }
            rel => {
                ...
                NewUnstableBeaconStartEventContent { beacon_start, text, relates_to }.into()
            }
        };
